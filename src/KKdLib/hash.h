...
extern uint64_t hash_fnv1a64m(const void* data, size_t length, bool make_upper);
...
extern uint64_t hash_string_fnv1a64m(const string* data, bool make_upper);
...
extern uint32_t hash_string_murmurhash(const string* data, uint32_t seed, bool upper);
...
extern uint16_t hash_string_crc16_ccitt(const string* data, bool make_upper);
