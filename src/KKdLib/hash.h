...
extern uint64_t hash_fnv1a64m(uint8_t* data, size_t length);
extern uint64_t hash_utf8_fnv1a64m(char* data);
extern uint64_t hash_utf16_fnv1a64m(wchar_t* data);
extern uint64_t hash_fnv1a64m_upper(uint8_t* data, size_t length);
extern uint64_t hash_utf8_fnv1a64m_upper(char* data);
extern uint64_t hash_utf16_fnv1a64m_upper(wchar_t* data);
