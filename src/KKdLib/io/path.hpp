...
extern void path_get_directories(std::vector<std::string>* directories,
    const char* path, char** exclude_list, size_t exclude_count);
extern void path_get_directories(std::vector<std::wstring>* directories,
    const wchar_t* path, wchar_t** exclude_list, size_t exclude_count);
extern void path_get_directories_recursive(std::vector<std::string>* directories,
    const char* path, char** exclude_list, size_t exclude_count);
extern void path_get_directories_recursive(std::vector<std::wstring>* directories,
    const wchar_t* path, wchar_t** exclude_list, size_t exclude_count);