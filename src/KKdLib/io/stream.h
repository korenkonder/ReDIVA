...
struct stream {
    ...
    stream_type type;
    bool is_big_endian;
    vector_old_int64_t position_stack;
};
...
extern void io_open(stream* s, const void* data, size_t size);
extern void io_open(stream* s, std::vector<uint8_t>* data);
extern void io_copy(stream* s, void** data, size_t* size);
extern void io_copy(stream* s, std::vector<uint8_t>* data);
extern void io_align_read(stream* s, int64_t align);
extern void io_align_write(stream* s, int64_t align);
extern int io_flush(stream* s);
extern int64_t io_get_length(stream* s);
extern int64_t io_get_position(stream* s);
extern int32_t io_set_position(stream* s, int64_t pos, int32_t seek);
extern int32_t io_position_push(stream* s, int64_t pos, int32_t seek);
extern void io_position_pop(stream* s);
extern int64_t io_read(stream* s, int64_t count);
extern int64_t io_read(stream* s, void* buf, int64_t count);
extern int64_t io_write(stream* s, int64_t count);
extern int64_t io_write(stream* s, void* buf, int64_t count);
extern int64_t io_write(stream* s, const void* buf, int64_t count);
...
extern void io_read_string_null_terminated_offset(stream* s, int64_t offset, string* str);
extern void io_read_string_null_terminated_offset(stream* s, int64_t offset, std::string* str);
extern void io_read_wstring_null_terminated_offset(stream* s, int64_t offset, wstring* str);
extern void io_read_wstring_null_terminated_offset(stream* s, int64_t offset, std::wstring* str);
extern char* io_read_utf8_string_null_terminated(stream* s);
extern wchar_t* io_read_utf16_string_null_terminated(stream* s);
extern char* io_read_utf8_string_null_terminated_length(stream* s, int64_t* length);
extern wchar_t* io_read_utf16_string_null_terminated_length(stream* s, int64_t* length);
extern char* io_read_utf8_string_null_terminated_offset(stream* s, int64_t offset);
extern wchar_t* io_read_utf16_string_null_terminated_offset(stream* s, int64_t offset);
extern char* io_read_utf8_string_null_terminated_offset_length(stream* s, int64_t offset, int64_t* length);
extern wchar_t* io_read_utf16_string_null_terminated_offset_length(stream* s, int64_t offset, int64_t* length);
...
extern int64_t io_read_offset(stream* s, int32_t offset, bool is_x);
extern int64_t io_read_offset_f2(stream* s, int32_t offset);
extern int64_t io_read_offset_x(stream* s);
extern void io_write_offset(stream* s, int64_t val, int32_t offset, bool is_x);
extern void io_write_offset_f2(stream* s, int64_t val, int32_t offset);
extern void io_write_offset_x(stream* s, int64_t val);
