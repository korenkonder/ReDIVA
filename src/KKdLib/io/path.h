...
extern void path_wget_files(vector_wstring* files, const wchar_t* path);
extern void path_get_directories(vector_string* directories, char* path,
    char** exclude_list, size_t exclude_count);
extern void path_get_directories(vector_string* directories, const char* path,
    char** exclude_list, size_t exclude_count);
extern void path_wget_directories(vector_wstring* directories, wchar_t* path,
    wchar_t** exclude_list, size_t exclude_count);
extern void path_wget_directories(vector_wstring* directories, const  wchar_t* path,
    wchar_t** exclude_list, size_t exclude_count);
extern void path_get_directories_recursive(vector_string* directories, char* path,
    char** exclude_list, size_t exclude_count);
extern void path_get_directories_recursive(vector_string* directories, const char* path,
    char** exclude_list, size_t exclude_count);
extern void path_wget_directories_recursive(vector_wstring* directories, wchar_t* path,
    wchar_t** exclude_list, size_t exclude_count);
extern void path_wget_directories_recursive(vector_wstring* directories, const  wchar_t* path,
    wchar_t** exclude_list, size_t exclude_count);