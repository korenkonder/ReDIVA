...
extern const char* str_utils_get_next_string(const char* str, std::string& value, char separator);
extern const wchar_t* str_utils_get_next_string(const wchar_t* str, std::wstring& value, wchar_t separator);
