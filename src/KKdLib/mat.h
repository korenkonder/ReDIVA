...
extern void FASTCALL mat3_from_mat4(mat4* x, mat3* z);
extern void FASTCALL mat3_from_mat4_inverse(mat4* x, mat3* z);
extern void FASTCALL mat3_get_scale(mat3* x, vec3* z);
...
extern void FASTCALL mat4_mult_vec3_trans(mat4* x, vec3* y, vec3* z);
...
extern void FASTCALL mat4_invrot(mat4* x, mat4* z);
...
extern void FASTCALL mat4_translate_add(mat4* s, float_t x, float_t y, float_t z, mat4* d);
extern void FASTCALL mat4_translate_x_add(mat4* x, float_t y, mat4* z);
extern void FASTCALL mat4_translate_y_add(mat4* x, float_t y, mat4* z);
extern void FASTCALL mat4_translate_z_add(mat4* x, float_t y, mat4* z);
extern void FASTCALL mat4_from_quat(quat* quat, mat4* mat);
extern void FASTCALL mat4_from_mat3(mat3* x, mat4* z);
extern void FASTCALL mat4_from_mat3_inverse(mat3* x, mat4* z);
extern void FASTCALL mat4_clear_rot(mat4* x, mat4* z);
extern void FASTCALL mat4_clear_trans(mat4* x, mat4* z);
extern void FASTCALL mat4_get_scale(mat4* x, vec3* z);
extern void FASTCALL mat4_get_translation(mat4* x, vec3* z);
extern void FASTCALL mat4_set_translation(mat4* x, vec3* z);
