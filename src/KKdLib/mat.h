...
extern void mat3_from_mat4(mat4u* x, mat3* z);
extern void mat3_from_mat4_inverse(mat4* x, mat3* z);
extern void mat3_from_mat4_inverse(mat4u* x, mat3* z);
...
extern void mat4_mult(mat4u* x, mat4u* y, mat4u* z);
...
extern void mat4_from_quat(quat* quat, mat4u* mat);
...
extern void mat4_get_scale(mat4u* x, vec3* z);
extern void mat4_get_rotation(mat4* x, vec3* z);
extern void mat4_get_rotation(mat4u* x, vec3* z);
extern void mat4_get_translation(mat4* x, vec3* z);
extern void mat4_get_translation(mat4u* x, vec3* z);
...
extern void mat4_blend(mat4u* x, mat4u* y, mat4u* z, float_t blend);
extern void mat4_blend_rotation(mat4* x, mat4* y, mat4* z, float_t blend);
extern void mat4_blend_rotation(mat4u* x, mat4u* y, mat4u* z, float_t blend);
extern void mat4_lerp_rotation(mat4* dst, mat4* src0, mat4* src1, float_t blend);
extern void mat4_lerp_rotation(mat4u* dst, mat4u* src0, mat4u* src1, float_t blend);
...
extern void mat4_look_at(vec3* eye, vec3* target, mat4* mat);
