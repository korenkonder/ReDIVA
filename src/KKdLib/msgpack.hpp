...
struct msgpack {
    ...
    int8_t read_int8_t(const char* name);
    uint8_t read_uint8_t(const char* name);
    int16_t read_int16_t(const char* name);
    uint16_t read_uint16_t(const char* name);
    int32_t read_int32_t(const char* name);
    uint32_t read_uint32_t(const char* name);
    int64_t read_int64_t(const char* name);
    uint64_t read_uint64_t(const char* name);
    float_t read_float_t(const char* name);
