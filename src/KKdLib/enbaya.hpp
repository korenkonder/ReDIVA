...
struct enb_play_head {
    ...
    uint8_t* track_data_init_i2;        // 0x34
    int8_t* track_data_init_i8;         // 0x38
    int16_t* track_data_init_i16;       // 0x3C
    int32_t* track_data_init_i32;       // 0x40
    uint8_t track_data_init_i2_counter; // 0x44
    uint8_t padding[3];                 // 0x45
    uint8_t* track_data_i2;             // 0x48
    uint8_t* track_data_i4;             // 0x4C
    ...
    uint8_t* orig_track_data_i2;        // 0x84
    uint8_t* orig_track_data_i4;        // 0x88
