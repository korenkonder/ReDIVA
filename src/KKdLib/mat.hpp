...
extern void mat3_set_column(mat3* in_m1, int32_t column, float_t in_x, float_t in_y, float_t in_z);
extern void mat3_set_row(mat3* in_m1, int32_t column, float_t in_x, float_t in_y, float_t in_z);
...
extern void mat4_set_column(mat4* in_m1, int32_t column, float_t in_x, float_t in_y, float_t in_z, float_t in_w);
extern void mat4_set_row(mat4* in_m1, int32_t column, float_t in_x, float_t in_y, float_t in_z, float_t in_w);
...
extern void mat4_mul_scale_w(const mat4* in_m1, float_t s, mat4* out_m);
...
extern void mat4_rotation_from_mat3(const mat4* in_m1, const mat3* in_m2, mat4* out_m);
extern void mat4_rotation_from_mat3_inverse(const mat4* in_m1, const mat3* in_m2, mat4* out_m);
...
extern float_t mat4_get_average_scale(const mat4* in_m1);
...
extern void mat4_frustum(float_t left, float_t right,
