...
typedef struct key_val {
    vector_ptr_char key;
    vector_size_t key_len;
    vector_ptr_char val;
    vector_size_t val_len;
    char* buf;
    vector_uint64_t key_hash;
    vector_size_t key_index;
} key_val;
...
extern bool key_val_read_string_ptr(key_val* kv, char* buf,
    size_t offset, char* str_add, size_t str_add_len, char** value);
extern void key_val_write_string(stream* s, char* buf,
    size_t offset, char* str_add, size_t str_add_len, string* value);
extern void key_val_write_string_ptr(stream* s, char* buf,
    size_t offset, char* str_add, size_t str_add_len, char* value);
...
extern void key_val_get_lexicographic_order(vector_int32_t* vec, int32_t length);
