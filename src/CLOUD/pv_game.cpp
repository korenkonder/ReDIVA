...
fov(), min_dist(), field_2BFD4(), field_2BFD5(), data_camera(), scene_fade_enable(), scene_fade_frame(),
scene_fade_duration(), scene_fade_start_alpha(), scene_fade_end_alpha(), scene_fade_color(), has_signature(),
has_perf_id(), field_2C4E4(), field_2C500(), scene_rot_y(), scene_rot_mat(), field_2C54C(),
...
TaskPvGame::Data::Data() : field_0(), field_4(), field_8(), score_percentage_clear(), life_gauge_safety_time(),
life_gauge_border(), field_1C(), modules(), items(), field_98(), field_A0(), field_A8(), field_190(),
field_191(), no_fail(), field_193(), field_194(), field_195(), field_196(), field_198() {
...
static void sub_140121A80(pv_game_old* a1, int32_t chara_id) {
    ...
    while(true) {
        i = sub_1401216D0(a1, DSC_FT_ITEM_ANIM, &time, &pv_branch_mode, i, i_end);
        if (!i)
            break;
...
static void sub_140122770(pv_game_old* a1, int32_t chara_id) {
    ...
    dsc_data* i_end = a1->dsc_m.data.data() + a1->dsc_m.data.size();
    while (true) {
        i = sub_1401216D0(a1, DSC_FT_SET_MOTION, &time, &pv_branch_mode, i, i_end);
        if (!i)
            break;
