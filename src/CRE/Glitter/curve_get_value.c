...
static void glitter_curve_get_key_indexes(std::vector<GlitterCurve::Key>* keys,
    float_t frame, size_t* curr, size_t* next);
static float_t glitter_curve_interpolate(GLT, GlitterCurve* c, float_t frame,
...
static float_t glitter_curve_randomize(GLT,
    GlitterCurve* c, float_t value, glitter_random* random);
static float_t glitter_curve_randomize_key(GLT,
    GlitterCurve* c, GlitterCurve::Key* key, glitter_random* random);

bool glitter_curve_get_value(GLT, GlitterCurve* c,
