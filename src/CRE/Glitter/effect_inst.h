...
extern void glitter_effect_inst_draw(GPM, glitter_effect_inst* a1, alpha_pass_type alpha);
extern alpha_pass_type glitter_effect_inst_get_alpha(glitter_effect_inst* a1);
