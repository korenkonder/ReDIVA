...
extern glitter_effect_group* glitter_particle_manager_get_effect_group(GPM, uint64_t effect_group_hash);
extern void glitter_particle_manager_get_frame(GPM, float_t* frame, int32_t* life_time);
extern glitter_scene* glitter_particle_manager_get_scene(GPM, uint64_t effect_group_hash);
