...
extern void glitter_render_group_calc_draw(GPM, glitter_render_group* a1);
extern bool glitter_render_group_cannot_draw(glitter_render_group* a1);
...
extern void glitter_render_group_update(GLT,
