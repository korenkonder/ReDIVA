...
typedef enum mothead_data_type {
    ...
    MOTHEAD_DATA_ROB_RESET   = 0x41,
    MOTHEAD_DATA_ROB_STEP    = 0x42,
...
public:
    ...
    virtual void Field_20(vector_old_bone_data*, vector_old_bone_data*) override;
...
extern void pv_osage_manager_array_ptr_init();
extern void pv_osage_manager_array_ptr_free();
