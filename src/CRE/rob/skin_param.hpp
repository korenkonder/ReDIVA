...
extern bool skin_param_manager_array_check_alive();

extern bool skin_param_manager_open(int32_t chara_id, std::vector<osage_init_data>& vec);
extern bool skin_param_manager_check_alive(int32_t chara_id);
...
extern std::vector<skin_param_file_data>* skin_param_manager_get_skin_param_file_data(
    int32_t chara_id, object_info obj_uid, uint32_t motion_id, int32_t frame);
...
extern key_val* skin_param_storage_get_key_val(object_info obj_uid);
