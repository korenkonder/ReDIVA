...
namespace mdl {
    ...
    enum ObjFlags : uint32_t {
        ...
        OBJ_8                            = 0x00000008,
        OBJ_10                           = 0x00000010,
        OBJ_SILHOUETTE                   = 0x00000020,
        OBJ_SILHOUETTE_HIGH              = 0x00000040,
    ...
    struct DispManager {
        ...
        void get_obj_center(const mat4& mat, const ObjSubMeshArgs* args, vec3& center);
