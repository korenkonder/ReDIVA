...
extern void FASTCALL glitter_x_render_element_rotate_mesh_to_emit_position(mat4* mat,
...
extern void FASTCALL glitter_x_render_element_rotate_mesh_to_prev_position(mat4* mat,
    glitter_render_group* a2, glitter_render_element* a3, vec3* vec, vec3* trans);
extern void FASTCALL glitter_x_render_element_rotate_to_emit_position(mat3* mat,
