...
extern bool draw_task_add_draw_object(render_context* rctx, object* obj,
...
extern bool draw_task_add_draw_object_by_object_info_opaque(render_context* rctx, mat4* mat,
    object_info obj_info);
extern void draw_task_sort(render_context* rctx, draw_object_type type, int32_t compare_func);
extern int32_t object_axis_aligned_bounding_box_check_visibility(
    object_axis_aligned_bounding_box* aabb, camera* cam, mat4* mat);
extern int32_t object_bounding_sphere_check_visibility(object_bounding_sphere* sphere,
