...
extern obj_mesh* object_storage_get_obj_mesh(object_info obj_info, char* mesh_name);
extern obj_mesh* object_storage_get_obj_mesh_by_index(object_info obj_info, int32_t index);
extern obj_mesh* object_storage_get_obj_mesh_by_object_hash(uint32_t hash, char* mesh_name);
extern obj_mesh* object_storage_get_obj_mesh_by_object_hash_index(uint32_t hash, int32_t index);
extern int32_t object_storage_get_obj_mesh_index(object_info obj_info, char* mesh_name);
extern int32_t object_storage_get_obj_mesh_index_by_hash(uint32_t hash, char* mesh_name);
...
extern int32_t object_storage_load_set(object_database* obj_db, const char* name);
extern int32_t object_storage_load_set(object_database* obj_db, uint32_t set_id);
extern bool object_storage_load_obj_set_check_not_read(uint32_t set_id);
extern void object_storage_load_set_hash(void* data, uint32_t hash);
