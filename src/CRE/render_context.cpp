...
void render_data_context::reset_shader_flags() {
    shader_flags.arr[U_TEX_COLOR] = 0;
    shader_flags.arr[U_BLEND_FUNC_01] = 0;
    shader_flags.arr[U_TEX_NORMAL] = 0;
    shader_flags.arr[U_TEX_SPECULAR] = 0;
    shader_flags.arr[U_TEX_PARENCY] = 0;
    shader_flags.arr[U_TEX_LUCENCY] = 0;
    shader_flags.arr[U_TEX_ENVMAP] = 0;
    shader_flags.arr[U_DOUBLE_SIDE] = 0;
    shader_flags.arr[U_SPECULAR] = 0;
    shader_flags.arr[U_FOG] = 0;
    shader_flags.arr[U_FOGMAP] = 0;
    shader_flags.arr[U_ANISO_TANGENT] = 0;
    shader_flags.arr[U_TEX_SHADOW] = 0;
    shader_flags.arr[U_UV_LAYER] = 0;
...
sprite_width(), sprite_height(), screen_x_offset(), screen_y_offset(), screen_width(), screen_height() {
    ...
    glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)0);
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 2));
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 4));
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(3, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 6));
    glEnableVertexAttribArray(4);
    glVertexAttribPointer(4, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 8));
    glEnableVertexAttribArray(5);
    glVertexAttribPointer(5, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 10));
    glEnableVertexAttribArray(6);
    glVertexAttribPointer(6, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 12));
    glEnableVertexAttribArray(7);
    glVertexAttribPointer(7, 2, GL_FLOAT, GL_FALSE, sizeof(float_t) * 16, (void*)(sizeof(float_t) * 14));
...
void render_context::init() {
    ...
    empty_texture_2d = texture_load_tex_2d(texture_id(0x2F, 0x00),
    ...
    empty_texture_cube_map = texture_load_tex_cube_map(texture_id(0x2F, 0x01),
