...
extern void light_set_ambient(light_data* light, vec4* value);
extern void light_get_diffuse(light_data* light, vec4* value);
extern void light_set_diffuse(light_data* light, vec4* value);
extern void light_get_specular(light_data* light, vec4* value);
extern void light_set_specular(light_data* light, vec4* value);
extern void light_get_position(light_data* light, vec3* value);
extern void light_set_position(light_data* light, vec3* value);
extern void light_get_position_vec4(light_data* light, vec4* value);
extern void light_set_position_vec4(light_data* light, vec4* value);
extern void light_get_spot_direction(light_data* light, vec3* value);
extern void light_set_spot_direction(light_data* light, vec3* value);
...
extern void light_set_attenuation(light_data* light, vec3* value);
extern void light_get_ibl_specular(light_data* light, vec4* value);
extern void light_set_ibl_specular(light_data* light, vec4* value);
extern void light_get_ibl_back(light_data* light, vec4* value);
extern void light_set_ibl_back(light_data* light, vec4* value);
extern void light_get_ibl_direction(light_data* light, vec4* value);
extern void light_set_ibl_direction(light_data* light, vec4* value);
extern void light_get_tone_curve(light_data* light, vec3* value);
extern void light_set_tone_curve(light_data* light, vec3* value);
extern void light_get_clip_plane(light_data* light, bool value[4]);
extern void light_set_clip_plane(light_data* light, bool value[4]);
