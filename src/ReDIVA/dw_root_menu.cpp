...
void dw_root_menu_init(dw::Menu* root_menu) {
    ...
    /*dw::MenuItem::Create(root_menu, dw::FLAG_8, L"PlayerData",
        (dw::Widget::Callback)player_data_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, L"Contest",
        (dw::Widget::Callback)contest_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, "Noblesse",
        (dw::Widget::Callback)noblesse_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, L"Quest",
        (dw::Widget::Callback)quest_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, L"Campaign",
        (dw::Widget::Callback)campaign_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, L"PV_SELECTOR",
        (dw::Widget::Callback)pv_selector_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, "Slider",
        (dw::Widget::Callback)slider_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, "CommFailure",
        (dw::Widget::Callback)comm_failure_dw_init);
    dw::MenuItem::Create(root_menu, dw::FLAG_8, "Closing Mode",
...
inline static void data_test_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"OSAGE TEST",
        (dw::Widget::Callback)data_test_osage_test_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"CHAR PERFORMANCE",
        (dw::Widget::Callback)data_test_char_performance_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"CHARA TEST",
        (dw::Widget::Callback)data_test_chara_test_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"MOTION FLAGS",
        (dw::Widget::Callback)data_test_motion_flags_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"NODE FLAGS",
        (dw::Widget::Callback)data_test_node_flags_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"CNS/EXP NODE",
        (dw::Widget::Callback)data_test_cns_exp_node_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"TEXTURE TEST",
        (dw::Widget::Callback)data_test_texture_test_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"SPRITE TEST",
        (dw::Widget::Callback)data_test_sprite_test_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ITEM EQUIP TEST",
        (dw::Widget::Callback)data_test_item_equip_test_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"SAVE & LOAD ITEM EQUIP",
        (dw::Widget::Callback)data_test_save_and_load_item_equip_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"MESH",
        (dw::Widget::Callback)data_test_mesh_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"SOUND",
        (dw::Widget::Callback)data_test_sound_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"MOVIE",
        (dw::Widget::Callback)data_test_movie_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ITEM DISP",
        (dw::Widget::Callback)data_test_item_disp_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ROB COLLISION",
        (dw::Widget::Callback)data_test_rob_collision_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ROB SLEEVE",
        (dw::Widget::Callback)data_test_rob_sleeve_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ROB SCALE",
        (dw::Widget::Callback)data_test_rob_scale_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ROB EFFECTOR SCALE",
        (dw::Widget::Callback)data_test_rob_effector_scale_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"ROB LOOK",
        (dw::Widget::Callback)data_test_rob_look_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"HAND ITEM",
        (dw::Widget::Callback)data_test_hand_item_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"CMN ITEM",
...
inline static void data_view_dw_init(dw::Menu* parent) { // Added
    ...
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Auth 3D",
        (dw::Widget::Callback)data_view_auth_3d_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Draw Task",
        (dw::Widget::Callback)data_view_draw_task_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Glitter",
        (dw::Widget::Callback)data_view_glitter_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Object",
        (dw::Widget::Callback)data_view_object_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Texture",
...
inline static void graphics_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"NVPerfKit",
        (dw::Widget::Callback)dw_perf_kit_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Light",
        (dw::Widget::Callback)light_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Face Light",
        (dw::Widget::Callback)dw_face_light_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Fog",
        (dw::Widget::Callback)fog_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Post process",
        (dw::Widget::Callback)dw_post_process_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Color Change",
        (dw::Widget::Callback)color_change_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Shadow",
        (dw::Widget::Callback)shadow_dw_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"Rendering",
        (dw::Widget::Callback)rendering_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Performance",
        (dw::Widget::Callback)performance_dw_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Global Material",
        (dw::Widget::Callback)global_material_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Material",
        (dw::Widget::Callback)material_dw_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"Ripple Effect",
        (dw::Widget::Callback)ripple_effect_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Rain Effect",
        (dw::Widget::Callback)rain_effect_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Snow Effect",
        (dw::Widget::Callback)snow_effect_dw_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Reflect/Refract",
        (dw::Widget::Callback)reflect_refract_dw_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"Wind",
        (dw::Widget::Callback)wind_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Show Vector",
        (dw::Widget::Callback)dw_show_vector_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Show MIPMAP level",
        (dw::Widget::Callback)dw_show_mipmap_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Splash",
        (dw::Widget::Callback)splash_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Fog Ring",
        (dw::Widget::Callback)fog_ring_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Star Effect",
        (dw::Widget::Callback)star_effect_dw_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Glitter",
        (dw::Widget::Callback)glitter_dw_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"Capture",
        (dw::Widget::Callback)capture_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"NPR Cloth",
        (dw::Widget::Callback)npr_cloth_specular_dw_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Render Settings",
...
inline static void information_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"System",
        (dw::Widget::Callback)system_dw_init);*/
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Console",
        (dw::Widget::Callback)dw_console_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Task",
        (dw::Widget::Callback)dw_task_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"FrameSpeed",
        (dw::Widget::Callback)frame_speed_window_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"a3d",
        (dw::Widget::Callback)a3d_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Rob Motion Info",
...
inline static void rob_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"Motkind flag",
        (dw::Widget::Callback)rob_motkind_flag_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Kaesare flag",
        (dw::Widget::Callback)rob_kaesare_flag_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Attack Sub",
        (dw::Widget::Callback)rob_attack_sub_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Offensive Move",
        (dw::Widget::Callback)rob_offensive_move_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"Yarare Test",
...
inline static void debug_camera_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"DEBUG_CAMERA",
        (dw::Widget::Callback)debug_camera_debug_camera_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"DEBUG_CAMERA_PSP",
        (dw::Widget::Callback)debug_camera_debug_camera_psp_dw_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"SET_DEBUG_CAMERA",
...
inline static void gui_internal_dw_init(dw::Menu* parent) {
    ...
    dw::MenuItem::Create(menu, dw::FLAG_8, L"InfoWindow...",
        (dw::Widget::Callback)dw_info_window_init);
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"DebugConsole...",
        (dw::Widget::Callback)dw_debug_console_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"FileViewer...",
        (dw::Widget::Callback)dwl_file_viewer_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"WindowDemo...",
        (dw::Widget::Callback)dw_window_demo_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"GraphDemo...",
        (dw::Widget::Callback)dw_graph_demo_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"RegionDemo...",
...
inline static void options_dw_init(dw::Menu* parent) {
    ...
    /*dw::MenuItem::Create(menu, dw::FLAG_8, L"ColorListWindow...",
        (dw::Widget::Callback)dw_color_list_window_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"FontListWindow...",
        (dw::Widget::Callback)dw_font_list_window_init);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"config save",
        &dw_gui_user_detail::selection_gui_user_save);
    dw::MenuItem::Create(menu, dw::FLAG_8, L"config load",
